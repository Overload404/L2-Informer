...
// Sharpen parameters
float fSharpScale = 0.06;						// intensity of sharpening
float2 fvTexelSize = float2(1.0 / 3840.0, 1.0 / 2160.0);	// set your resolution sizes

// Depth of field parameters
float fFocusBias = 0.055;						// bigger values for nearsightedness, smaller for farsightedness (lens focal point distance)
...
float fBlurScale = 0.008;						// governs image blur scale (the bigger value, the stronger blur)
